...
It turns out that the way the problem is designed, it breaks on a recursive solution. What?! Yup. And it takes an hour or two of trying things, before you just accept that not using recursion might be an implicit part of the specc.
