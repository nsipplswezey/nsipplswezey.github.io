...
Someday, day 5 will actually be Day 5. By that I mean, things take longer than you'd expect. Things change, suddenly sometimes. Starting is easy, making progress is fun, finishing is hard.

In the spirit of finishing, here's a nugget from the current status of the front end 
...
Is that they take a slightly different form from NYC and SF. So while the options hash might be consistent, I imagine there's going to be some fine tuning of the actual scraping. I'll give that a shot tomorrow.

Overall, I think this is what good work looks like.
