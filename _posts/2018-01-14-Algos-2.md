...
Our last post highlighted the importance of three pieces in the ritual of algorithms: Ask questions to discover constraints, try something once you think you have an understanding and maintain a relaxed perserverence.
...
While writing this, I actually misinterpreted the example, but following `Relax and perserve` got me back on track. This is the ritual.
...
This is the moment where "try something" transitions to `relax and perserve`. And also where I'm starting to have another insight.
